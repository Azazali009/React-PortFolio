...
const Certificates = () => {
  return (
    <section className=" mb-12 pb-12 pt-40 sm:pt-48 md:pt-20">
      ...
      {/* Map certificates */}
      <div className=" mt-6 grid grid-cols-1 items-start gap-x-4 gap-y-8 sm:mt-16 md:grid-cols-2 lg:grid-cols-3">
